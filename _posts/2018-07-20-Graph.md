...
* 방향을 가지는 그래프(Directed graph)
  ...
  * 예: 네트워크 라우터
  ...
  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph3.png)
...
* 방향을 가지지 않는 그래프(Undirected graph)
  ...
  * 예 비행 노선
  ...
  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph4.png)
...
* 순환이 없는 그래프를 트리라고 부른다, 트리는 비순환(acyclic) 연결 그래프이다.
  ...
  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph5.png)



* 하나의 정점으로 이루어진 간선을 자기 순환(self loop)이라 합니다.

  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph6.png)



* 두 간선이 동일한 쌍의 정점을 가진다면 두 간선은 평행합니다.

  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph7.png)
...
* 그래프에서 경로(Path)는 순차적인 인접(adjacent) 정점들입니다. 단순 경로(simple path)는 동일한 정점이 중복되어 나타나지 않는 경로입니다. 아래 그림에서 점선으로 표시된 G에서 E로의 경로는 단순 경로입니다.
  ...
  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph8.png)



* 어떤 경로의 첫 번째 정점과 마지막 정점이 동일한 것을 사이클(cycle)이라고 합니다(첫 번째와 마지막 정점을 제외하고). 반복되는 정점이나 사선이 없는 사이클을 단순 사이클(simple cycle)이라 합니다.

  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph9.png)
...
* 연결 그래프가 아니라면 그래프는 연결 컴포넌트들의 집합으로 구성됩니다(컴포넌트 : 무향 그래프의 연결 컴포넌트는 두 개의 정점이 경로에 의해 서로 연결되어 있으면서 그외 부모 그래프의 어떤 정점과도 연결되어 있지 않은 부분 그래프입니다).
  ...
  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph10.png)



* DAG(Directed Acyclic Graph)는 사이클을 가지지 않는 유향 그래프를 말합니다.

  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph11.png)
...
* 이분(Bipartiie) 그래프는 모든 정점을 두 개의 집합으로 나누고 모든 간선들이 한쪽 집합에 있는 정점에서 다른 집합에 있는 정점으로 연결된 그래프입니다.
  ...
  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph12.png)



* 가중 그래프에서 가중치(weights)는 거리나 비용 등을 나타내기 위해 간선에 부여되는 값 또는 비용입니다.

  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph13.png)
...
* 가능한 모든 간선을 가지는 그래프를 완전 그래프(complete graph)라고 합니다.
  ...
  ![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph14.png)
...
![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph15.png)



위 그래프는 다음과 같은 인접 매트릭스로 표현할 수 있습니다.

![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph16.png)
...
![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph17.png)
...
![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph18.png)
...
![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph19.png)

![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph20.png)

![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph21.png)

![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph22.png)

![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph23.png)
...
![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph24.png)

![](/Users/kimdonghwan/Documents/공부/전공/My Blog/알고리즘/Graph/Images/graph25.png)
